...
final class SeedAnimeContent extends Command
{
    ...
    protected $description = 'Fetch latest anime videos from curated channels and dispatch transcription. Up to 3 videos per run with Redis rate limiting.';
    ...
    public function handle(): int
    {
        ...
        if ($dispatched === 0) {
            $this->info('No new anime videos to process.');
        }
    ...
    {
        /** @var object{error_message: string|null}|null $task */
